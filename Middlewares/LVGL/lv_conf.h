...
#define LV_USE_DRAW_SW  1
    ...
    #define LV_DRAW_SW_LAYER_SIMPLE_BUF_SIZE          (100 * 1024) //(24 * 1024)   /*[bytes]*/

    /*Used if `LV_DRAW_SW_LAYER_SIMPLE_BUF_SIZE` couldn't be allocated.*/
    #define LV_DRAW_SW_LAYER_SIMPLE_FALLBACK_BUF_SIZE (100 * 1024) //(3 * 1024)    /*[bytes]*/

    /*Allow buffering some shadow calculation.
    *LV_DRAW_SW_SHADOW_CACHE_SIZE is the max. shadow size to buffer, where shadow size is `shadow_width + radius`
    *Caching has LV_DRAW_SW_SHADOW_CACHE_SIZE^2 RAM cost*/
    #define LV_DRAW_SW_SHADOW_CACHE_SIZE 20 //0

    /* Set number of maximally cached circle data.
    * The circumference of 1/4 circle are saved for anti-aliasing
    * radius * 4 bytes are used per circle (the most often used radiuses are saved)
    * 0: to disable caching */
    #define LV_DRAW_SW_CIRCLE_CACHE_SIZE 20  //4
     ...
     *0 mean no caching.*/
    #define LV_DRAW_SW_GRADIENT_CACHE_DEF_SIZE (1024*100)  //0
    ...
    #define LV_DRAW_SW_GRADIENT_DITHER  1  //0
    #if LV_DRAW_SW_GRADIENT_DITHER
        /*Add support for error diffusion dithering.
         *Error diffusion dithering gets a much better visual result, but implies more CPU consumption and memory when drawing.
         *The increase in memory consumption is (24 bits * object's width)*/
        #define LV_DRAW_SW_GRADIENT_DITHER_ERROR_DIFFUSION  1 //0
    #endif
...
#define LV_DISP_ROT_MAX_BUF (200*1024)   //(10*1024)
 ...
 *0: to disable caching*/
#define LV_IMG_CACHE_DEF_SIZE  20  //0
...
#define LV_USE_FS_FATFS 1
    ...
    #define LV_FS_FATFS_CACHE_SIZE   (1024*200)//0    /*>0 to cache this number of bytes in lv_fs_read()*/
#endif
